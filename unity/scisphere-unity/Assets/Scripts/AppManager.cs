...
public class AppManager : MonoBehaviour
{
  ...
  public void showHelp()
  {
    ...
    switch (currentState)
    {
      ...
      case AppStates.DS_MENU:
        HelperPrompt.GetComponent<TMP_Text>().text = "About SciSphere";
        Description.GetComponent<TMP_Text>().text = "SciSphere is an augmented reality (AR) based computer science education app that is dedicated to teaching data structure implementation. It offers a unique and immersive learning experience by utilizing AR technology to visualize and explore various data structures.\nThe app is designed specifically for computer science students and enthusiasts who want to enhance their understanding and implementation skills in data structures. SciSphere utilizes AR to bring these abstract concepts to life by overlaying virtual objects and visualizations onto the real world, making it easier for users to grasp the intricacies of implementing different data structures.\nThrough Sphere, users can interact with three-dimensional representations of popular data structures such as arrays, linked lists, stacks and queues. They can manipulate these structures, observe their behavior, and gain practical experience in implementing them. The AR environment allows users to visualize the inner workings of data structures, understand their relationships, and explore how they store and organize data.";
        break;
  ...
  {
    print("Called Flutter Message: exit");
